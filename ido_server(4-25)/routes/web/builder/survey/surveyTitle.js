...
exports.surveyTitle = function(req, res){
	...
	form.parse(req,function(err, fields, files){
		...
		//db file컬럼 정보
		var fileDir = '/upload_img/'+renameFile;  
		...
		client.query('INSERT INTO survey_tb(contents_id, survey_title, survey_thumbnail) VALUES(1, ?, ?)', [surveyTitle, fileDir], function(error, rst){
